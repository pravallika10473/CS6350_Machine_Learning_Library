...
X_test = test_data  # Assuming you've already removed the target label from the test data
...
predictions = decision_tree.predict_proba(X_test)  # Probability predictions

# Assuming that predictions[:, 1] represents the probability of "income > 50K"
# You can adjust this based on the output of your DecisionTreeClassifier

# Generate an array of IDs for the test data
...
predictions_df.to_csv("output/decissionTreepredictions.csv", index=False)